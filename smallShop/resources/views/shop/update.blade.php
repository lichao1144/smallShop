  ...
  <body>
    <div class="maincont">
     ...
     <div class="head-top">
      ...
      <div class="lrBox">
        <input type="hidden" id="address_id" name="address_id" value="{{$info->address_id}}">
       <div class="lrList"><input type="text" value="{{$info->address_name}}" id="address_name" placeholder="收货人" /></div>
     
      
        <select id="province" class="changearea">
         <option value="0" selected="selected">省份/直辖市</option>
         @foreach($addressInfo as $key=>$value)
         <option @if($info->province == $value->id) selected @endif  value="{{$value->id}}">{{$value->name}}</option>
         @endforeach
        </select>
        ...
        <select id="area" class="changearea">
         ...
         <div class="lrList"><input type="text" value="{{$info->address_detail}}" id="address_detail" placeholder="详细地址" /></div>
       <div class="lrList"><input type="text" id="address_tel" placeholder="手机" value="{{$info->address_tel}}" /></div>
      </div><!--lrBox/-->
      <div class="lrSub">
       <input type="submit" id="updateHandle" value="修改" />
      </div>
